...
const conString = 'postgres://ValerieSiira@localhost:5432/kilovolt';
...
// Answer:
// function will run a query that checks if tables exists, if not, it will create a table and load the articles.
loadDB();
