...
app.get('/new', function(request, response) {
  ...
  // #5; Article.prototype.toHtml; Update;
...
app.delete('/articles/:id', function(request, response) {
  // COMMENT: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // #3, Article.prototype.deleteRecord(); Delete;
  client.query(
...
app.delete('/articles', function(request, response) {
  // COMMENT: What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  //#3; Article.prototype.truncateTable();Delete;
  client.query(
...
// Creating base table and keys, attempts to load data, loads default data from file and populates db with default data.
loadDB();
